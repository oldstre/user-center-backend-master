...
import com.wry.usercenter.contant.UserConstant;
import com.wry.usercenter.model.domain.User;
import com.wry.usercenter.model.domain.request.UserLoginRequest;
import com.wry.usercenter.model.domain.request.UserRegisterRequest;
...
public class UserController {
    ...
    private boolean isAdmin(HttpServletRequest request) {
        ...
        return user != null && user.getUserRole() == UserConstant.ADMIN_ROLE;//是管理员返回1
    }
